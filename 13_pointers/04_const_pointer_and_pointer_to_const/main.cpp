...
int main(){
    ...
    int *ptr1{nullptr};  // pointer to int 

    const int *ptr2{&x}; // pointer to const int 
    // cann't change the data in its location " *ptr2=10; "

    int *const ptr3{&y}; // const pointer to int 
    // cann't point ot any othe location " ptr3 = &z; "

    const int* const ptr4{&x}; // const pointer to const int
    // cann't change the data in its location.
    // cann't point ot any othe location.
    ...
    *p_number7 = 456;
    ...
    //important not the pointer to string is >>>>>> pointer to const
    //you can point to other location but cant change the content of this location
