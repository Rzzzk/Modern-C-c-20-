...
// ------------------------------------------------------------------------------------------------------------ //
    ...
    std::cout << "The 2D array size (bytes)      :  " << sizeof(_2D_Array) << std::endl ;    // 48 byte
    std::cout << "The inner array size (bytes)   :  " << sizeof(_2D_Array[0]) << std::endl ; // 16 byte
    std::cout << "The element size (bytes)       :  " << sizeof(_2D_Array[0][0]) << std::endl ; // 4 byte

// ------------------------------------------------------------------------------------------------------------ //

    std::cout << "The 2D array size    :  " << sizeof(_2D_Array)/sizeof(_2D_Array[0]) << std::endl ; // 3 elements
    std::cout << "The 2D array size    :  " << std::size(_2D_Array) << std::endl ; // 3 elements

// ------------------------------------------------------------------------------------------------------------ //

    std::cout << "The inner array size    :  " << sizeof(_2D_Array[0])/sizeof(_2D_Array[0][0]) << std::endl ; // 4 elements
    std::cout << "The inner array size    :  " << std::size(_2D_Array[0]) << std::endl ; // 4 elements

// ------------------------------------------------------------------------------------------------------------ //

    std::cout << "The 2D array size (all elements)   :  " << sizeof(_2D_Array)/sizeof(_2D_Array[0][0]) << std::endl ; // 12 elements
    std::cout << "The 2D array size (all elements)   :  " << std::size(_2D_Array[0]) * std::size(_2D_Array) << std::endl ; // 12 elements
