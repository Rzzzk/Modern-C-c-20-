...
/* 
 the array of characters is a normal array but,
 the '\0' problm is just when you try to print a string,
 the cout print the characters and stop at '\0' */ 
    ...
    std::cout << "numbers :  " << numbers << std::endl; // print the array address
